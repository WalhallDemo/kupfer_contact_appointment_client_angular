(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser'), require('rxjs/operators'), require('@angular/common/http'), require('ngx-dropzone-wrapper'), require('moment'), require('@angular/common'), require('ngx-mydatepicker'), require('@angular/forms'), require('@angular/core'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('freyja-ui', ['exports', '@angular/platform-browser', 'rxjs/operators', '@angular/common/http', 'ngx-dropzone-wrapper', 'moment', '@angular/common', 'ngx-mydatepicker', '@angular/forms', '@angular/core', 'rxjs'], factory) :
    (factory((global['freyja-ui'] = {}),global.ng.platformBrowser,global.rxjs.operators,global.ng.common.http,global.ngxDropzoneWrapper,global.moment_,global.ng.common,global.ngxMydatepicker,global.ng.forms,global.ng.core,global.rxjs));
}(this, (function (exports,i2,operators,i1,ngxDropzoneWrapper,moment_,common,ngxMydatepicker,forms,i0,rxjs) { 'use strict';
    ...
    var FreyjaService = /** @class */ (function () {
        ...
        FreyjaService.ngInjectableDef = i0.defineInjectable({ factory: function FreyjaService_Factory() { return new FreyjaService(); }, token: FreyjaService, providedIn: "root" });
    ...
    ***************************************************************************** */
    ...
    var IconBaseComponent = /** @class */ (function (_super) {
        ...
        IconBaseComponent.propDecorators = {
            icon: [{ type: i0.Input }],
            iconMargin: [{ type: i0.Input }],
            iconFill: [{ type: i0.Input }],
    ...
    var CheckboxComponent = /** @class */ (function (_super) {
        ...
        function CheckboxComponent() {
             ...
             */
            _this.change = new i0.EventEmitter(false);
            return _this;
        }
    ...
    var CheckboxGridComponent = /** @class */ (function () {
        function CheckboxGridComponent() {
            ...
            this.checkboxClicked = new i0.EventEmitter();
        }
    ...
    var TextInputComponent = /** @class */ (function (_super) {
        ...
        function TextInputComponent() {
             ...
             */
            _this.mouseout = new i0.EventEmitter();
            return _this;
        }
    ...
    var IconRegistryService = /** @class */ (function () {
        ...
        IconRegistryService.prototype.loadSvgIconFromConfig = function (config) {
            ...
            return this.fetchUrl(config.url)
                .pipe(operators.map(function (svgText) { return _this.createSvgElementForSingleIcon(svgText); }));
        };
        ...
        IconRegistryService.prototype.fetchUrl = function (safeUrl) {
            ...
            var req = this.httpClient.get(url, {
                responseType: 'text', headers: new i1.HttpHeaders({
                    'Access-Control-Allow-Origin': '*'
                })
            }).pipe(operators.finalize(function () { return _this.inProgressUrlFetches.delete(url); }), operators.share());
        ...
        IconRegistryService.prototype.getNamedSvgIcon = function (name) {
            ...
            if (config) {
                if (config.svgElement) {
                    ...
                    return this.loadSvgIconFromConfig(config).pipe(operators.tap(function (svg) { return config.svgElement = svg; }), operators.map(function (svg) { return cloneSvg(svg); }));
                }
            }
        };
        ...
        /** @nocollapse */
        IconRegistryService.ctorParameters = function () {
            return [
    ...
    var SvgIconComponent = /** @class */ (function (_super) {
        ...
        SvgIconComponent.prototype.loadSvgIconByName = function () {
            var _this = this;
            if (this.svgName) {
                this._iconRegistryService.addSvgIcon(this.svgName).pipe(operators.take(1)).subscribe(function (svg) { return _this.insertSvgElement(svg); }, function (err) { return console.log("Error retrieving icon: " + err.message); });
            }
        };
        /**
    ...
    var CardItemComponent = /** @class */ (function () {
        function CardItemComponent(eRef) {
             ...
             */
            this.elementEdited = new i0.EventEmitter();
            /**
        ...
        /** @nocollapse */
        CardItemComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
        CardItemComponent.propDecorators = {
            ...
            isHighlight: [{ type: i0.Input }],
            actionClicked: [{ type: i0.Output }],
            elementEdited: [{ type: i0.Output }],
            lightBox: [{ type: i0.ViewChild, args: [LightBoxComponent,] }]
        };
    ...
    var NativeDropdownComponent = /** @class */ (function (_super) {
        ...
        NativeDropdownComponent.propDecorators = {
            ...
            id: [{ type: i0.Input }],
            width: [{ type: i0.Input }],
            showDefaultOnCLick: [{ type: i0.Input }],
            optionSelected: [{ type: i0.Output }],
            error: [{ type: i0.Input }],
            controlName: [{ type: i0.Input }],
            formGroup: [{ type: i0.Input }]
    ...
    var FjDragAndDropComponent = /** @class */ (function () {
        function FjDragAndDropComponent() {
            this.uploadedDoc = new i0.EventEmitter();
            this.fileToUpload = new i0.EventEmitter();
            this.disabled = false;
        ...
        FjDragAndDropComponent.propDecorators = {
            componentRef: [{ type: i0.ViewChild, args: [ngxDropzoneWrapper.DropzoneComponent,] }],
            directiveRef: [{ type: i0.ViewChild, args: [ngxDropzoneWrapper.DropzoneDirective,] }],
            uploadedDoc: [{ type: i0.Output }],
            fileToUpload: [{ type: i0.Output }],
            removeFile: [{ type: i0.Input }],
            noFileSelected: [{ type: i0.Input }]
        };
    ...
    var FjDragAndDropModule = /** @class */ (function () {
        ...
        FjDragAndDropModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        exports: [FjDragAndDropComponent, ngxDropzoneWrapper.DropzoneModule],
                        providers: [
                            {
    ...
    var DatePickerComponent = /** @class */ (function (_super) {
        ...
        function DatePickerComponent() {
            ...
            _this.dateChangeValue = new i0.EventEmitter();
            _this.dateChangeEvent = new i0.EventEmitter();
            return _this;
        }
        ...
        DatePickerComponent.propDecorators = {
            ...
            formOfOrigin: [{ type: i0.Input }],
            timePicker: [{ type: i0.Input }],
            timeLabel: [{ type: i0.Input }],
            required: [{ type: i0.Input }],
            error: [{ type: i0.Input }],
            dateTime: [{ type: i0.Input }],
            fileCreateDate: [{ type: i0.Input }],
            customStyles: [{ type: i0.Input }],
            errored: [{ type: i0.Input }],
            ngxdp: [{ type: i0.ViewChild, args: ['dp',] }],
            myDefaultMonth: [{ type: i0.Input }],
            myOptions: [{ type: i0.Input }],
            dateChangeValue: [{ type: i0.Output }],
            dateChangeEvent: [{ type: i0.Output }]
        };
    ...
    var DatePickerService = /** @class */ (function () {
        function DatePickerService() {
            this.getProgramDirectEntryCalendarStartDate = new rxjs.Subject();
            this.getEditProgramCalendarStartDate = new rxjs.Subject();
            this.getEditActivityCalendarStartDate = new rxjs.Subject();
            this.getApprovalCalendarStartDate = new rxjs.Subject();
            this.getCreateMilestoneCalendarStartDate = new rxjs.Subject();
        }
    ...
    var FjDatePickerModule = /** @class */ (function () {
        ...
        FjDatePickerModule.decorators = [
            { type: i0.NgModule, args: [{
                        imports: [
                            common.CommonModule,
                            ngxMydatepicker.NgxMyDatePickerModule,
                            forms.ReactiveFormsModule,
                            IconModule
                        ],
                        providers: [DatePickerService, ngxMydatepicker.NgxMyDatePickerConfig],
    ...
    exports.ɵd = DatePickerService;
    exports.ɵb = BaseComponent;
    exports.ɵa = IconBaseComponent;
    exports.ɵc = IconRegistryService;
    exports.FreyjaService = FreyjaService;
    exports.FreyjaComponent = FreyjaComponent;
    exports.FreyjaModule = FreyjaModule;
    exports.ButtonComponent = ButtonComponent;
    exports.FjButtonModule = FjButtonModule;
    exports.CheckboxComponent = CheckboxComponent;
    exports.FjCheckboxModule = FjCheckboxModule;
    exports.RadioButtonComponent = RadioButtonComponent;
    exports.FjRadioButtonModule = FjRadioButtonModule;
    exports.CheckboxGridComponent = CheckboxGridComponent;
    exports.CheckboxGridModule = CheckboxGridModule;
    exports.NumberInputComponent = NumberInputComponent;
    exports.FjNumberInputModule = FjNumberInputModule;
    exports.TextInputComponent = TextInputComponent;
    exports.FjTextInputModule = FjTextInputModule;
    exports.SvgIconComponent = SvgIconComponent;
    exports.FjSvgIconModule = FjSvgIconModule;
    exports.AccordionComponent = AccordionComponent;
    exports.FjAccordionModule = FjAccordionModule;
    exports.ContentSwitcherComponent = ContentSwitcherComponent;
    exports.FjContentSwitcherModule = FjContentSwitcherModule;
    exports.CardItemComponent = CardItemComponent;
    exports.FjCardItemModule = FjCardItemModule;
    exports.NativeDropdownComponent = NativeDropdownComponent;
    exports.FjNativeDropdownModule = FjNativeDropdownModule;
    exports.ModalComponent = ModalComponent;
    exports.FjModalModule = FjModalModule;
    exports.IconComponent = IconComponent;
    exports.IconModule = IconModule;
    exports.FjDragAndDropComponent = FjDragAndDropComponent;
    exports.FjDragAndDropModule = FjDragAndDropModule;
    exports.ɵ0 = ɵ0;
    exports.DatePickerComponent = DatePickerComponent;
    exports.FjDatePickerModule = FjDatePickerModule;
    exports.LightBoxComponent = LightBoxComponent;
    exports.FjLightBoxModule = FjLightBoxModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=freyja-ui.umd.js.map