...
import { Injectable, Input, Optional, SecurityContext, Component, NgModule, Output, EventEmitter, ElementRef, ViewEncapsulation, ViewChild, defineInjectable, inject } from '@angular/core';
...
/** @nocollapse */
FreyjaComponent.ctorParameters = () => [];
 ...
 */
class IconBaseComponent extends BaseComponent {
    constructor() {
        super(...arguments);
        /**
 ...
 */
let nextId = 0;
class ButtonComponent extends IconBaseComponent {
     ...
     */
    generateStyles() {
        return Object.assign({}, this.customStyles, { margin: this.margin });
    }
    /**
...
class RadioButtonComponent extends BaseComponent {
    constructor() {
        ...
        this.uniqueInputId = `fj-radio-button-${++nextId$2}`;
        /**
         * Provide unique ID or it will use auto generated from counter
         */
        this.id = `fj-radio-button-${++nextId$2}`;
        /**
...
class NumberInputComponent extends BaseComponent {
    constructor() {
         ...
         * Provide unique ID or it will use auto generated from counter
         */
        this.id = `fj-number-input-${++nextId$3}`;
        /**
...
class TextInputComponent extends BaseComponent {
    constructor() {
         ...
         */
        this.id = `fj-text-input-${++nextId$4}`;
        /**
 ...
 */
class SvgIconComponent extends BaseComponent {
    /**
...
class ContentSwitcherComponent {
    constructor() {
        /**
...
let nextId$6 = 0;
class NativeDropdownComponent extends BaseComponent {
    constructor() {
        super();
        /**
...
const DEFAULT_DROPZONE_CONFIGURATIONS = {
    url: '/',
    maxFiles: 1,
    dictDefaultMessage: '',
...
const ɵ0 = DEFAULT_DROPZONE_CONFIGURATIONS;
class FjDragAndDropModule {
}
